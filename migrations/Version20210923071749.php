 ...
 */
final class Version20210923071749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, id_matiere_id INT NOT NULL, id_eleve_id INT DEFAULT NULL, note INT NOT NULL, coefficient INT NOT NULL, date DATE NOT NULL, INDEX IDX_CFBDFA1451E6528F (id_matiere_id), INDEX IDX_CFBDFA145AB72B27 (id_eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE prof (id INT AUTO_INCREMENT NOT NULL, id_matiere_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_de_naissance DATE DEFAULT NULL, INDEX IDX_5BBA70BB51E6528F (id_matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
